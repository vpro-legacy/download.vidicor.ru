...
function RMXFViewer(url, tag)
{
  ...
  {
    var instText1 = "If you do not see video/sound then you have to install ";
    var instText2 = "<b><i>Vidicor</i></b> Watcher";
    var instText3 = "Click this link, run the file and follow its instructions.";
    var instText4 = "Press <b>F5</b> when installation completed.";
    var instText5 = "Attention! The page requires additional component to operate.\n" +
                    "Press OK and follow instructions.";
    if (lang == 'ru')
    {
        instText1 = "Если не видите видео и не слышите звука &mdash; установите ";
        instText2 = "просмотрщик <b><i>Vidicor</i></b>";
        instText3 = "Нажмите на эту ссылку, запустите файл и следуйте его инструкциям.";
        instText4 = "После завершения установки нажмите <b>F5</b>.";
...
{
  var instText1 = "You have to install ";
  var instText2 = "<b><i>Vidicor</i></b> View Component";
  var instText3 = "Click the link and run the file then follow his instructions.";
  var instText4 = "Press <b>F5</b> since installation complete.";
  ...
  if (lang == 'ru')
  {
    instText1 = "Необходимо установить ";
    instText2 = "просмотрщик <b><i>VidicoR</i></b>";
    instText3 = "Нажмите на <b><i>Window</i></b> или <b><i>Viewer</i></b>, запустите файл и следуйте его инструкциям.<p>";
    instText4 = "После завершения установки нажмите <b>F5</b>.";

...
function RMXFViewer(url, tag)
{
  ...
  var UDPPortsList = ("80,9000").split(",");
  var TCPPortsList = ("80,9000").split(",");
...
//  if ((urlparse.proto == "rmxvp") || (urlparse.proto == "rmxdp"))
  ...
  this.rmxfprm[this.rmxfprm.length] = "ResizeWindowOnStart=0";
  this.rmxfprm[this.rmxfprm.length] = "maintainVideoAspectRatio=0";
  ...
  if (!UAisUnknown)
  {
    var recvhtml = "files/rmxfrecv.html";
  ...
  {
    var instText1 = "This browser can't use ActiveX/Plugin component!<p>" +
...
//                    "Press OK and follow the component installation instructions.";
    ...
    if (lang == "ru")
    {
      instText1 = "Данный интернет-браузер не позволяет<br>использовать ActiveX/Plugin компонент просмотра!<p>" +
...
{
  var text4ref = true;
  var instText1 = "You have to install<br>Vidicor View Component<p>";
  var instText2 = "<b>Click this link</b> to install ActiveX/Plugin component.";
...
//                  "Press OK and follow component installation instructions.";
  ...
  if (lang == "ru")
  {
    instText1 = "Вам необходимо установить<br>компонент просмотра видео Vidicor<p>";
    instText2 = "<b>Нажмите на эту ссылку</b>, чтобы установить ActiveX компонент";
...
//                "Нажмите OK и следуйте появившимся инструкциям по установке ActiveX компонента.";
